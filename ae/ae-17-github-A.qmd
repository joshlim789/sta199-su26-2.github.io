...
We will use **tidyverse** and **tidymodels** for data exploration and modeling and the **knitr** package for formatting tables.
The dataset was scraped from Wikipedia and the Olympics website.
...
The data represent the scores of every dive during the final rounds of the 2024 Paris Olympic games diving events.
Each diver performs six dives.
Suppose we are interested in how well we can predict a diver's last round dive score from his running total of five dives (i.e. is there a "streak" in diving.)
