...
::: callout-important
You must attend this lab in person and participate in the peer review in person to be eligible for the points for this milestone.
...
Review one other teams' project.
As a team you should spend \~30 minutes on the review.

-   Find the names of the team whose project you're reviewing below.
...
```{r}
#| message: false
teams <- read_sheet("https://docs.google.com/spreadsheets/d/1HeY9Rqo2byQeWKnU_OmQe45QR7EKcYW-xKTmp25R2hw/edit?gid=722119601#gid=722119601", 
                    sheet = "review")
