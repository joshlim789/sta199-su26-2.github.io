...
## Some final thoughts on inference {.medium}

- Our whole goal is trying to make a statement about the population
- Make sure to be able to articulate your population!
- In our diving dataset, we assumed that out "sample" were all the finalist divers at the 2024 Olympics
- What does that generalize to?
- Key challenge when designing any sample, survey, experiment etc: get a sample that is representative of your population. 

## Final thoughts part 2 (foreshadowing)

- We conducted inference mainly on one thing: the slope for a simple linear regression
- Could we do something similar for other models?
- What would inference for a logistic regression model look like?
