...
- Estimation: "our best guess"
- Interpretation
- Rinse and Repeat
- But what about those error bars? What about those extra columns in our output tables?
...
## But first a message from the Capitol

![](img/17/reaping.webp){fig-align="center" width="150%"}

## The Reaping
- Suppose that my 199 class is the population of interest
- Each of you will take a sample of 3, and compute the mean
- Do you all expect to get the same value?
- May the odds be ever in your favor
- What if we increased the sample size?
...
## But first, let's dive our way back to the 2024 Paris Olympics

::: columns
::: {.column width="50%"}
![](img/19/inward.gif){fig-align="center" width="70%"}
:::

::: {.column width="50%"}
![](img/19/doublepike.gif){fig-align="center" width="70%"}
:::
:::
...
![](img/19/divingoly.jpg){fig-align="center" width="50%"}
